...
const Login = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-evenly w-[80%]'>
        ...
        <div>
        <div className="my-5">
        <h1 className="font-bold text-6xl"> Happpening now.</h1>
        </div>
        <h1 className="mt-4 mb-2 text-2xl font-bold">{isLogin ? "login" : "sign up"}</h1>
...

          {
            ...
            <button className="bg-[#1098F0] border-none py-2 my-4 rounded-full text-lg text-white" >{isLogin ? "login" : "Create Account"}</button>
